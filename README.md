...
React, TypeScript 기반의 6년차 프론트엔드 개발자 정상헌의 포트폴리오 웹사이트입니다.

## 👨‍💻 소개

- **이름**: 정상헌 (Sanghun Jeong)
- **직무**: Front-end Developer
- **경력**: 6년 (2020 - 현재)
- **전문 분야**: 블록체인(DeFi, Web3), AI, Full-Stack 개발
...
### 씨피랩스 (2022.03 - 2025.12)
- **WemixFi**: WEMIX DeFi 서비스 개발 (Swap, Staking, Pool, Lending)
- **Metadium Explorer**: 블록체인 탐색기 개발 및 AI 챗봇 MCP Server 구현
- **WEMIX Web Wallet**: 블록체인 지갑 서비스 개발
- **WEB2X**: Web3 REST API 서비스 개발
- **ANPR**: AI 기반 자동 번호판 인식 시스템 개발

### 슬로그 (2020.02 - 2021.07)
- **슬로그**: 영상 기반 학습시간 관리 서비스 Full-Stack 개발
